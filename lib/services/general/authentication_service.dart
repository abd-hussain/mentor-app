...
class AuthenticationService with Service {
  ...
  Future<AuthenticationBiometricType> getAvailableBiometricTypes(TargetPlatform? platform) async {
    ...
    AuthenticationBiometricType response = AuthenticationBiometricType(isAvailable: false, type: BiometricType.face);
      ...
      if (platform == TargetPlatform.iOS) {
        ...
        for (final biometricType in listOfBiometrics) {
          if (biometricType == BiometricType.face) {
            response = AuthenticationBiometricType(isAvailable: true, type: BiometricType.face);
          } else {
            response = AuthenticationBiometricType(isAvailable: true, type: BiometricType.fingerprint);
          }
        }
      }
