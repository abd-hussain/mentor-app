...
class Register4Bloc {
  ...
  fillListOfWorkingHourNotifier(BuildContext context) {
    ...
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.saturday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.sunday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.monday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.tuesday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.wednesday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.thursday));
    listOfWorkingHourNotifier.value
        .add(WorkingHourModel(list: prepareList(context, []), dayName: AppLocalizations.of(context)!.friday));
  }
